...
var MARKED_ELEMENTS_CSS =   '.eventFinder_jqEvent {background: #FF00EE;} ' + 
                            '.eventFinder_jqEvent:hover {border: 2px solid #002FFF;} ' +
                            '.eventFinder_jqLive {background: gold;} ' +
...
var IS_WIN = navigator.userAgent.toLowerCase().indexOf('windows') !== -1;
